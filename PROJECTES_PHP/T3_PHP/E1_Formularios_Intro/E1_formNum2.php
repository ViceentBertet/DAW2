...
<html>
    ...
    <body>
        ...
        <?php
            $num1 = $_GET['num1'];
            $num2 = $_GET['num2'];
            if (empty($num1) && empty($num2)) echo "<b>Ambos campos están vacíos</b>";
            else if (empty($num1)) echo "<b>El primer campo está vacío</b>";                
            else if (empty($num2)) echo "<b>El segundo campo está vacío</b>";
            else {
                $suma = $num1 + $num2;
                $resta = $num1 - $num2;
                $mult = $num1 * $num2;
